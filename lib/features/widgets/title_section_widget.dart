...
import 'package:seller/features/widgets/hr.dart';
import 'package:seller/features/widgets/icon_svg_widget.dart';
      ...
      children: [
        Row(
          children: [
            ...
            Padding(
              padding:
                  EdgeInsets.symmetric(horizontal: scaleFontSize(horizontalPt)),
              child: Row(
