...
import 'package:seller/features/widgets/chip_widgett.dart';
  ...
  ButtonColors get _colors {
    ...
    switch (widget.variant) {
      case BtnVariant.primary:
        return ButtonColors(
          background:
              isDisabled ? Colors.grey.shade300 : widget.bgColor ?? secondary,
          text: isDisabled ? Colors.grey.shade500 : widget.textColor ?? white,
          border: isDisabled
              ? Colors.grey.shade300
              : widget.borderColor ?? (widget.bgColor ?? secondary),
        );
      ...
      case BtnVariant.secondary:
        return ButtonColors(
          ...
          text: isDisabled
              ...
              : widget.textColor ?? Colors.grey.shade800,
          border: isDisabled
      ...
      case BtnVariant.outline:
        return ButtonColors(
          ...
          text:
              isDisabled ? Colors.grey.shade400 : widget.textColor ?? secondary,
          border: isDisabled
              ? Colors.grey.shade300
    ...
    return Material(
      ...
      child: InkWell(
        ...
        splashColor: widget.enableRipple
            ? colors.text.withValues(alpha: .1)
            : Colors.transparent,
        highlightColor: widget.enableRipple
            ? colors.text.withValues(alpha: .05)
            : Colors.transparent,
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(_borderRadius),
            border: widget.variant == BtnVariant.outline ||
                    widget.variant == BtnVariant.secondary
                ...
                ? [
                    BoxShadow(
                      color: widget.shadowColor ??
                          colors.background.withValues(alpha: .3),
        ...
        children: [
          ...
          if (widget.isLoading) ...[
            SizedBox(
              ...
              width: _fontSize,
              child:
                  CircularProgressIndicator(color: colors.text, strokeWidth: 2),
            ),
            if (widget.loadingText != null || widget.title.isNotEmpty)
...
class ButtonColors {
  ...
  const ButtonColors(
      {required this.background, required this.text, required this.border});
}
